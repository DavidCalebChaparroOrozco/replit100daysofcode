...
title = f"{colorChange('red')}{colorChange('white')}{colorChange('blue')} {colorChange('yellow')}Rock Station {colorChange('blue')}{colorChange('white')}{colorChange('red')}"

print(f"        {title:^45}")
print(f"▶️\t{colorChange('white')}Back in Black")
print(f"\t{colorChange('yellow')}AC/DC")
