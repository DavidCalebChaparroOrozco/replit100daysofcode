...
def getCode(code):
  if code == 0:
    ...
    return "Show fall: Light, moderate, and dense intensity"
  elif code == 77:
    return "Show grains"
  elif code == 80 or code == 81 or code == 82:
    return "Rain showers: Slight, moderate and violent"
  elif code == 85 or code == 86:
    return "Show showers slight and heavy"
  elif code == 95:
...
min_t = user["daily"]["temperature_2m_min"][0]
max_t = user["daily"]["temperature_2m_max"][0]
print(f"{getCode(weatherCode)}\n hot: {max_t}\t cold: {min_t} ")
